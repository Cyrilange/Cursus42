...
ClapTrap::ClapTrap()  : Name("") , HitPoints(10) , EnergyPoints(10) , AttackDamage(0), isScav(false) , isFrag(false) , isDia(false) {
    std::cout << "\033[94m" << "Default constuctor called" << "\033[0m" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : Name(name) , HitPoints(10) , EnergyPoints(10) , AttackDamage(0) , isScav(false) , isFrag(false), isDia(false) {
