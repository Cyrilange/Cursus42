...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/05 18:26:09 by csalamit          #+#    #+#             */
/*   Updated: 2026/01/05 18:26:10 by csalamit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat& Bureaucrat::operator=(const Bureaucrat& other) {
	...
	/*_name is a constant data member, so it cannot be reassigned after object construction.
	A Bureaucrat’s identity must remain immutable.
	the assignment operator only updates the modifiable attribute, _grade.*/
}
...
Bureaucrat::~Bureaucrat() { std::cout << "destructor called to "<< this->getName() << std::endl; }
